# Build stage
FROM golang:1.26.5-alpine@sha256:eb37f58646a901dc7727cf448cae36daaefaba79de33b5058dab79aa4c04aefb AS builder
...
COPY --from=builder --chown=appuser:appuser /app/brother-exporter .

# Expose port
EXPOSE 8092

# Run the application
CMD ["./brother-exporter"]
